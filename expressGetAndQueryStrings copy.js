...
// originally from node-express-course-main/02-express-tutorial/expressGetAndQueryStrings.js

const express = require('express')
const app = express()

const {products, people} = require('./node-express-course-main/02-express-tutorial/data')
